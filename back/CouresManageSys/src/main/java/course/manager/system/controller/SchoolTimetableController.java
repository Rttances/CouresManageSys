...
public class SchoolTimetableController {
    ...
    @Operation(summary = "分页条件查询课程表")
    @PostMapping("/page")
    public ResponseResult<PageVO<SchoolTimetableVO>> pageQueryCourse(@RequestBody PageRO<SchoolTimetableRO> schoolTimetableROPageRO) {
        PageVO<SchoolTimetableVO> schoolTimetableVOPageVO = schoolTimetableService.pageQuery(schoolTimetableROPageRO);
        return ResponseResult.success(schoolTimetableVOPageVO);
    }
